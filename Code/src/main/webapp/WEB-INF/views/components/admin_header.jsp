...
<header class="admin-header">
    <div class="logo" style="display: flex; align-items: center; gap: 10px;">
        ...
        <h2><c:choose><c:when test="${not empty applicationScope.hotelInfo.name}">${applicationScope.hotelInfo.name}</c:when><c:otherwise>Grand Lotus</c:otherwise></c:choose> Admin</h2>
    </div>
