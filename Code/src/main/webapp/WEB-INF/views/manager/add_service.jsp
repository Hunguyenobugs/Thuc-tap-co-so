...
<body><div class="layout"><jsp:include page="../components/sidebar.jsp"/><main class="main-content fade-in">
    ...
    <div class="card" style="max-width:600px;"><form method="post" action="${pageContext.request.contextPath}/manager/service"><input type="hidden" name="action" value="insert">
        ...
        <div class="btn-group"><button type="submit" class="btn btn-primary">💾 Lưu</button><a href="${pageContext.request.contextPath}/manager/service?action=manage" class="btn btn-outline">← Quay lại</a></div>
    </form></div>
