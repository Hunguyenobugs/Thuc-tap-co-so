                        ...
                        <div class="confirm-box">
                            ...
                            <div class="card mb-3">
                                <ul class="detail-list">
                                    <li><span class="label">Mã phiếu đặt</span><span
                                            class="value fw-bold">${booking.code}</span></li>
                                    <li><span class="label">Khách hàng</span><span
                                            class="value">${booking.customerName}</span></li>
                                    <li><span class="label">SĐT</span><span
                                            class="value">${booking.customerPhone}</span></li>
                                    <li><span class="label">Trạng thái</span><span
                                            class="value fw-bold">${booking.status}</span></li>
                                    <li><span class="label">Ngày đặt</span><span class="value">
                            ...
                            <form method="post" action="${pageContext.request.contextPath}/staff/cancel">
                                ...
                                <div class="btn-group" style="justify-content:center;">
                                    <a href="${pageContext.request.contextPath}/staff/cancel?action=search"
