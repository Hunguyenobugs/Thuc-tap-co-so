                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fullName" class="form-control"
                                        value="${inputUser != null ? inputUser.fullName : ''}" required>
                                </div>
                                <div class="form-group">
                                    <label>Mã NV <span class="required">*</span></label>
                                    <input type="text" name="employeeCode" class="form-control"
                                        value="${inputUser != null ? inputUser.employeeCode : ''}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="username" class="form-control"
                                        value="${inputUser != null ? inputUser.username : ''}" required>
                                </div>
                                <div class="form-group">
                                    <label>Vai trò</label>
                                    <select name="role" class="form-control">
                                        <option value="STAFF" ${inputUser !=null && inputUser.role=='STAFF' ? 'selected'
                                            : '' }>Nhân viên</option>
                                        <option value="MANAGER" ${inputUser !=null && inputUser.role=='MANAGER'
                                            ? 'selected' : '' }>Quản lý</option>
                                        <option value="ADMIN" ${inputUser !=null && inputUser.role=='ADMIN' ? 'selected'
                                            : '' }>Admin</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                        value="${inputUser != null ? inputUser.email : ''}" required>
                                </div>
                                <div class="form-group">
                                    <label>SĐT <span class="required">*</span></label>
                                    <input type="tel" name="phone" class="form-control"
                                        value="${inputUser != null ? inputUser.phone : ''}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="joinDate" class="form-control"
                                        value="${inputUser != null ? inputUser.joinDate : ''}" required>
                                </div>
                                <div class="form-group">
                                    <label>Mô tả</label>
                                    <input type="text" name="description" class="form-control"
                                        value="${inputUser != null ? inputUser.description : ''}">
                                </div>
                            </div>
