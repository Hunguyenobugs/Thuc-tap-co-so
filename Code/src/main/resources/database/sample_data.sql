...
-- Booking (Dữ liệu khớp với tình trạng phòng hiện tại: Tháng 5 năm 2026)
-- Để có dữ liệu Manager/Admin: Thêm 3 hóa đơn tháng trước (tháng 4), 2 hóa đơn tháng này (tháng 5)
-- Những phòng đang sử dụng: 102, 201, 305, 412
-- Những booking chờ duyệt: 1 cái
-- Những booking đã xác nhận nhưng chưa checkin: 1 cái
...
-- 4 phòng Đang lưu trú tương ứng với phòng Đang sử dụng (102, 201, 305, 412)
...
(9,  'PD2026050009', 1,  4, '2026-05-08 07:00:00', 2000000.00, '2026-05-08 07:05:00', 'Đang lưu trú', NULL),

-- Booking tương lai và chờ duyệt
(10, 'PD2026050010', 2,  3, '2026-05-08 12:00:00', 800000.00,  '2026-05-08 12:05:00', 'Đã xác nhận',  'Đến muộn'),
(11, 'PD2026050011', 3,  NULL, '2026-05-08 15:00:00', 0, NULL, 'Chờ xác nhận', 'Vui lòng gọi lại xác nhận');
...
-- Cũ
(1,  1, '2026-04-11 14:00:00', '2026-04-13 12:00:00', '2026-04-11 14:00:00', '2026-04-13 11:00:00', 800000.00, TRUE),
(2,  8, '2026-04-16 14:00:00', '2026-04-19 12:00:00', '2026-04-16 15:00:00', '2026-04-19 10:30:00', 1500000.00, TRUE),
(3,  10, '2026-04-21 14:00:00', '2026-04-24 12:00:00', '2026-04-21 14:30:00', '2026-04-24 11:00:00', 2500000.00, TRUE),
(4,  12, '2026-05-02 14:00:00', '2026-05-05 12:00:00', '2026-05-02 14:00:00', '2026-05-05 11:00:00', 1500000.00, TRUE),
(5,  13, '2026-05-04 14:00:00', '2026-05-06 12:00:00', '2026-05-04 15:00:00', '2026-05-06 12:00:00', 2200000.00, TRUE),

-- Đang lưu trú
(6,  2,  '2026-05-06 14:00:00', '2026-05-10 12:00:00', '2026-05-06 14:00:00', NULL, 800000.00, TRUE),   -- Phòng 102
(7,  4,  '2026-05-06 14:00:00', '2026-05-09 12:00:00', '2026-05-06 14:30:00', NULL, 800000.00, TRUE),   -- Phòng 201
(8,  8,  '2026-05-07 14:00:00', '2026-05-12 12:00:00', '2026-05-07 15:00:00', NULL, 1500000.00, TRUE),  -- Phòng 305
(9,  12, '2026-05-08 14:00:00', '2026-05-11 12:00:00', '2026-05-08 14:00:00', NULL, 1500000.00, TRUE),  -- Phòng 412

-- Tương lai
(10, 1, '2026-05-12 14:00:00', '2026-05-15 12:00:00', NULL, NULL, 800000.00, FALSE),
(11, 7, '2026-05-15 14:00:00', '2026-05-20 12:00:00', NULL, NULL, 1500000.00, FALSE);

-- Used Services
INSERT INTO tbl_used_service (booking_id, service_id, quantity, unit_price, used_date) VALUES
(2, 6, 1, 500000.00, '2026-04-17 15:00:00'),
(3, 3, 2, 150000.00, '2026-04-22 20:00:00'),
(3, 4, 1, 60000.00,  '2026-04-23 08:00:00'),
(4, 1, 5, 200000.00, '2026-05-03 07:00:00'),
(4, 8, 1, 400000.00, '2026-05-05 06:00:00'),
(6, 3, 1, 150000.00, '2026-05-07 20:00:00'),
(8, 1, 2, 200000.00, '2026-05-08 07:30:00');
...
(1, 'HD2026041301', 1, 3, '2026-04-13 11:30:00', 1600000.00, 0, 0, 1600000.00, 1600000.00, 'Tiền mặt', NULL),
(2, 'HD2026041901', 2, 3, '2026-04-19 11:00:00', 4500000.00, 500000.00, 0, 5000000.00, 5000000.00, 'Thẻ tín dụng', NULL),
(3, 'HD2026042401', 3, 4, '2026-04-24 11:30:00', 7500000.00, 360000.00, 0, 7860000.00, 7860000.00, 'Chuyển khoản', NULL),
(4, 'HD2026050501', 4, 3, '2026-05-05 11:30:00', 4500000.00, 1400000.00, 0, 5900000.00, 5900000.00, 'Tiền mặt', NULL),
(5, 'HD2026050601', 5, 4, '2026-05-06 12:00:00', 4400000.00, 0, 0, 4400000.00, 4400000.00, 'Thẻ tín dụng', NULL);
